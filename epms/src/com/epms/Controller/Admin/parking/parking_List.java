...
@WebServlet("/Parking.do")
public class parking_List extends HttpServlet {
	...
	public void doUser(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		int listCount = dao.getParkingListCount(list);
		...
		ArrayList<Parking_area_Bean> qlist = dao.getParkingList(list);
		...
		RequestDispatcher dis = req.getRequestDispatcher("/admin/parking/parkingList.jsp");
